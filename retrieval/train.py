...
# Data
train_set = video_data.Video_Data(args=args, seq_len=seq_len, seg=args.seg, num_class=num_actor_class, model_name=args.id, num_slots=args.num_slots, box=args.box)
