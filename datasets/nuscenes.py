...
class TACO(Dataset):
    ...
    def __init__(self, 
        ...
        b_plus_stat = {'b12': 0, 'b+13':0, 'b+14':0,
                    'b+:z2-z1': 0, 'b+23': 0, 'b+24': 0,
                    'b+:z3-z1': 0, 'b+32': 0, 'b+34': 0,
                    'b+:z4-z1': 0, 'b+42': 0, 'b+43': 0}
        ...
        for label_file in label_files:
            with open('./' + label_files + '.txt') as f:
                for line in tqdm(f):
                    line = line.replace('\n', '')
                    line = line.split(',')
                    start_frame, ego_gt, actor_gt = line[0], line[1], line[2]
                    actor_gt = actor_gt.split(' ')
                    ego_gt, actor_gt = get_labels(ego_gt, actor_gt, num_slots=args.num_slots)
