...
```
To participate in the challenge, you only need to compress the generated .pkl file with .zip format and upload it to [eval.ai platform](https://eval.ai/web/challenges/challenge-page/2301/submission).
